...
Si tenemos dos funciones lineales $f_1(x) = a_1 x + b_1$ y $f_2(x) = a_2 x + b_2$, entonces la composición puede simplificarse a: $f_3(x) = f_1(f_2(x)) = (a_1 a_2 ) x + (a_1 b_2 + b_1). 
