...
def cambio(monedas, cambio_objetivo):
    ...
    for moneda in monedas:
        ...
        if moneda <= resto:
            ...
            # agrego la moneda 'cantidad' veces a la lista de resultado
            resultado.extend([moneda] * cantidad)
            resto = resto % moneda
...
- CONTRAEJEMPLO (Fundamental para el examen):
  ...
  Para sistemas no canónicos, lo vamos a ver despues con Programación Dinámica (Dynamic Programming).
"""