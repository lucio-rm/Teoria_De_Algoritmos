\section{Resumen}
Se presenta un resumen del Trabajo Práctico 1 realizado...
...
Se presenta un resumen del Trabajo Práctico 1 realizado, hablando sobre el algoritmo implementado, explicando bien las medidas, complejidad, optimalidad, etc.
